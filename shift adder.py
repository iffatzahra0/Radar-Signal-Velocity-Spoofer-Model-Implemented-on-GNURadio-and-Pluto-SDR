...
class iffattransmitterspoof(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "spoof transmitter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("spoof transmitter")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "iffattransmitterspoof")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 2000000*2
...
def main(top_block_cls=iffattransmitterspoof, options=None):
